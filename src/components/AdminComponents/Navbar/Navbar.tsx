...
function Navbar() {
  ...
  return (
    <>
      <div className={`${style.nav} d-flex flex-shrink-0`}>
        <span
          onClick={() => {
        ...
        <hr />
        <ul
          className={`nav nav-pills flex-column mb-auto ${style.ul} ${style["fade-custom"]}`}
          ref={ulRef}
        >
            ...
            return (
              ...
              >
                <div
                  ...
                  } text-white  d-flex align-items-center gap-2`}
                  aria-current="page"
                >
                  {item.icon}
                  {item.name}
        ...
        <div>
          <ToggleLoginBtn
            className={[style["admin-dropdown"]]}
            isAdmin={true}
          />
        </div>
      </div>
